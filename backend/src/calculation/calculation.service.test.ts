...
describe('WeightedContinuousService', () => {
  ...
  test('computes term grade with coursework and exam', () => {
    const result = strategy.calculateSubjectTermGrade({
      ...
      groups: [
        { id: 'g-cw', name: 'Coursework', weight: 40, sortOrder: 0, isExam: false },
        { id: 'g-ex', name: 'Exam', weight: 60, sortOrder: 1, isExam: true },
      ],
      assessments: [
        {
          id: 'a1',
...
describe('ContinuousCumulativeService', () => {
  ...
  test('term grade uses only coursework (no exam)', () => {
    const result = strategy.calculateSubjectTermGrade({
      ...
      groups: [
        { id: 'g-cw', name: 'Coursework', weight: 100, sortOrder: 0, isExam: false },
        { id: 'g-ex', name: 'Exam', weight: 0, sortOrder: 1, isExam: true },
      ],
      assessments: [
        {
          id: 'a1',

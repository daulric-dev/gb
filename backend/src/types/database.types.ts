...
export type Database = {
  chat: {
    Tables: {
      conversation: {
        Row: {
          ...
          school_id: string
          title: string | null
          type: Database["chat"]["Enums"]["conversation_type"]
        }
        Insert: {
          created_at?: string | null
          created_by?: string | null
      ...
      message: {
        Row: {
          action_state: Database["chat"]["Enums"]["message_action_state"] | null
          body: string | null
          conversation_id: string
          created_at: string | null
          ...
          school_id: string
          sender_id: string
          type: Database["chat"]["Enums"]["message_type"]
        }
        Insert: {
          action_state?:
            | Database["chat"]["Enums"]["message_action_state"]
            | null
          body?: string | null
          conversation_id: string
          created_at?: string | null
    ...
    Enums: {
      ...
      message_action_state: "pending" | "accepted" | "dismissed"
      message_type: "text" | "file_share" | "class_invite" | "system"
    }
    CompositeTypes: {
      [_ in never]: never
    }
  ...
  file_manager: {
    Tables: {
      ...
      notification: {
        ...
        Relationships: [
          {
            foreignKeyName: "file_notification_file_id_fkey"
            columns: ["file_id"]
            isOneToOne: false
            referencedRelation: "file"
            referencedColumns: ["id"]
